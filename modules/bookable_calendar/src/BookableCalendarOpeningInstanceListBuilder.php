...
/**
 * Provides a list controller for the bookable calendar opening instance entity type.
 */
class BookableCalendarOpeningInstanceListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\bookable_calendar\BookableCalendarOpeningInstanceInterface */
