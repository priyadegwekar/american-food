...
class __TwigTemplate_f30768d6390abea1d8665a8850d4e3c0a39cd91ed21822f8e541e1a09dab7c2c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/opt/lampp/htdocs/american-food/themes/bootstrap/templates/input/input--button.html.twig");
    }
